...
if (computer_choice == 'bua' and player_choice == 'keo') or \
        (computer_choice == 'keo' and player_choice == 'bao') or \
        (computer_choice == 'bao' and player_choice == 'bua'):
    print('Ban da thua!')

elif (computer_choice == 'keo' and player_choice == 'bua') or \
        (computer_choice == 'bao' and player_choice == 'keo') or \
        (computer_choice == 'bua' and player_choice == 'bao'):
    print('Ban da thang!')
